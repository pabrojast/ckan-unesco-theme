...
QUEUE_DEFS = [
    ...
    {'id': 'ihpix_reports', 'icon': 'fa-university', 'scope': 'sysadmin',
     'helper': 'get_pending_ihpix_reports_count',
     'route': 'theme_ejemplo.ihpix_reports_admin'},
    {'id': 'ihpix_wg_members', 'icon': 'fa-users', 'scope': 'user',
     'helper': 'get_pending_ihpix_wg_members_count',
     'route': 'theme_ejemplo.ihpix_workspaces'},
    {'id': 'open_learning', 'icon': 'fa-graduation-cap', 'scope': 'sysadmin',
     'helper': 'get_pending_open_learning_count',
     'route': 'theme_ejemplo.open_learning_admin'},
...
def _labels():
    ...
    return {
        ...
        'ihpix_reports': _('IHP-IX reports'),
        'ihpix_wg_members': _('IHP-IX working group requests'),
        'open_learning': _('Open Learning course proposals'),
