...
| DOC-024 | IHP-IX/i18n | Cadenas de la fase iv (workspaces, membresías, emails de working group) traducidas es/fr/ar en los `.po`; el `.pot` sigue sin regenerar (DOC-013). | Baja |
